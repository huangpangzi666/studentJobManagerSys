    ...
    <body id="top_logo">
        <form action="${pageContext.request.contextPath }/admin/faculty" id="form" style="width: 100% !important;">
            <div class="form-group">
              ...
              <input type="text" value="${faculty.name }" name="name" class="form-control" id="inputSuccess1" aria-describedby="helpBlock2" onchange="able(this)">
            </div>
            <div class="form-group">
              <label class="control-label" for="inputSuccess2">描述</label>
              <textarea name="description" class="form-control" id="inputSuccess2" aria-describedby="helpBlock2" rows="5">${faculty.description }</textarea>
            </div>
       ...
       var isable = true;
	    	...
	    	$.get(
	    		...
	    		function(result) {
	    			 if (result.status == 'SUCCESS') {
	    				 ...
	    				 if ($.trim($("#inputSuccess1").val()) != "${faculty.name}") {
        ...
        $(document).ready(function() {
            $(form).bootstrapValidator({
                ...
                if (description != '${faculty.description}') {
