...
<html lang="zh-CN">
    ...
    <body>
     ...
     <article class="show">
        <header>
            <h2>
              <a rel="bookmark" href="submit.html">
                  高数第二节求微积分
              </a>
            </h2>
 ...
 2018-10-10</time>
        ...
        <footer class="tags">
            <span class="tag color2" rel="tag" >
                验收时间：2018-11-29 22:07:28</span>
            <span class="tag color2" rel="tag" >
                    班级：2015软件工程</span>
            <span class="tag color2" rel="tag">
                课程：高等代数</span>
            <span class="tag color2" rel="tag">
                发布人：网老师</span>
            <a href="#"><span class="glyphicon glyphicon-paperclip" aria-hidden="true">附件</span></a>
            <a rel="nofollow" >
